...
function getSuccessMessage(condType, bumpName, bumpConfig, conditionStatus = null) {
    ...
    // Replace {bumpName} placeholder
    let message = template.replace(/{bumpName}/g, `<strong>${bumpName}</strong>`);
...
//     // If bump is selected, always hide notification
//     if (isBumpSelected) {
...
//                 const message = getSuccessMessage(bumpConfig.conditions.type, bumpConfig.productName, bumpConfig, conditionStatus);
